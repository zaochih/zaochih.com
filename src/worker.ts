...
//   1. www.zaochih.com / zaochih.com -> about.zaochih.com (host canonicalization)
//   2. "/" -> best-matching locale route, based on Accept-Language
//
// The host check only matches the two literal legacy hostnames, not "anything
...
const REDIRECT_HOSTS = new Set(['zaochih.com', 'www.zaochih.com']);
